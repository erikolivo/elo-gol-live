...
def seleccionar():
    ...
    for f in fixtures_api:
        ...
        # CONSOLIDACION elo-gol-live: se guarda el diccionario completo de
        # goal_index (gi_*_dict), no solo el numero, porque poisson_model.py
        # (heredado de GEM1) usa goles_favor_prom/goles_contra_prom de cada
        # equipo -- si no vienen, cae solo en el promedio de liga por defecto.
        ...
        # rd_home/rd_away: poisson_model.py pondera el rating por la
        # incertidumbre Glicko-2 (RD alto = mas cerca de la media 1500)
        # antes de estimar los goles esperados -- ver aplicar_rd() alli.
